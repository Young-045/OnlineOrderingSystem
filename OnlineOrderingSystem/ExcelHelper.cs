...
namespace OnlineOrderingSystem
{
    public class ExcelHelper : IDisposable
    {
        ...
        public List<Channel> ExcelToDataTable(string sheetName, bool isFirstRowColumn)
        {
            ISheet sheet = null;
            ...
            try
            {
                ...
                if (sheet != null)
                {
                    ...
                    for (int i = startRow; i <= rowCount; ++i)
                    {
                        ...
                        //{
                        if (row.GetCell(1) != null) //同理，没有数据的单元格都默认是null
                        {
                            ...
                            var link = row.GetCell(1).Hyperlink.Address.ToString();
                            
                            //dataRow[i] = row.GetCell(1).ToString();
